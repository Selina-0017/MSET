...
module {
  ...
  func.func @f() -> i32 {
    ...
    %read_value_152 = memref.alloca() : memref<8xi8>
    memref.copy %origin, %read_value_152 : memref<8xi8> to memref<8xi8>
    %use_val_read_value_152 = memref.load %read_value_152[%c0] : memref<8xi8>
