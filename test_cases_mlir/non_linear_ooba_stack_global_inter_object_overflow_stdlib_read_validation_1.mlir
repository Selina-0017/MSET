...
module {
  ...
  func.func @f() -> i32 {
    ...
    %read_value_331 = memref.alloca() : memref<8xi8>
    %src_slice = memref.subview %target[%c0][8][1] : memref<8xi8> to memref<8xi8, strided<[1], offset: ?>>
    memref.copy %src_slice, %read_value_331 : memref<8xi8, strided<[1], offset: ?>> to memref<8xi8>
    %use_val_read_value_331 = memref.load %read_value_331[%c0] : memref<8xi8>
    func.call @use(%use_val_read_value_331) : (i8) -> ()
