...
module {
  ...
  func.func @f() -> i32 {
    ...
    %parent = memref.alloc() : memref<564xi8>
    ...
    %use_val_parent_target = memref.load %parent_target[%c0] : memref<8xi8, strided<[1], offset: 556>>
    ...
    scf.for %reach_index = %c0 to %c0 step %c1 {
      memref.store %c0xFF, %parent_target[%reach_index] : memref<8xi8, strided<[1], offset: 556>>
    }
    scf.for %i = %c0 to %c8 step %c1 {
      memref.store %c0xFF, %parent_target[%i] : memref<8xi8, strided<[1], offset: 556>>
    }
    func.call @exit(%test_success) : (i32) -> ()

    memref.dealloc %parent : memref<564xi8>
    return %c0_i32 : i32
  }
