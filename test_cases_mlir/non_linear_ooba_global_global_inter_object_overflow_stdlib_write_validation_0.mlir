...
module {
  ...
  memref.global @parent : memref<863xi8> = dense<170>
  ...
  func.func @f() -> i32 {
    ...
    %parent = memref.get_global @parent : memref<863xi8>
    ...
    scf.for %j = %c0 to %c8 step %c1 {
      ...
      memref.store %c0xFF, %parent_target[%idx] : memref<8xi8, strided<[1], offset: 855>>
    }
