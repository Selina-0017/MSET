...
module {
  ...
  memref.global @parent : memref<695xi8> = dense<170>
  ...
  func.func @f() -> i32 {
    ...
    %parent = memref.get_global @parent : memref<695xi8>
    %parent_origin = memref.subview %parent[0][8][1] : memref<695xi8> to memref<8xi8, strided<[1], offset: 0>>
    %parent_target = memref.subview %parent[687][8][1] : memref<695xi8> to memref<8xi8, strided<[1], offset: 687>>
