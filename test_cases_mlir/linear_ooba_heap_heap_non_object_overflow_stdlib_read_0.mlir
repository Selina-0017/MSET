...
module {
  ...
  func.func @f() -> i32 {
    ...
    %read_value_146 = memref.alloca() : memref<1024xi8>
    ...
    ^bb0(%i: index):
      ...
      %dst_slice = memref.subview %read_value_146[%c0][%step][1] : memref<1024xi8> to memref<?xi8, strided<[1], offset: ?>>
    ...
    %use_val_read_value_146 = memref.load %read_value_146[%c0] : memref<1024xi8>
    func.call @use(%use_val_read_value_146) : (i8) -> ()
    %read_value_148 = memref.alloca() : memref<8xi8>
    memref.copy %origin, %read_value_148 : memref<8xi8> to memref<8xi8>
