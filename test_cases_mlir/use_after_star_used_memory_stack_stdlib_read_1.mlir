...
module {
  ...
  %read_value_35 = memref.alloca() : memref<8xi8>
  memref.copy %saved_ptr, %read_value_35 : memref<8xi8> to memref<8xi8>
  %use_val_read_value_35 = memref.load %read_value_35[%c0] : memref<8xi8>
