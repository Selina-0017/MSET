...
module {
  ...
  memref.global @parent : memref<586xi8> = dense<170>
  ...
  func.func @f() -> i32 {
    ...
    %parent = memref.get_global @parent : memref<586xi8>
    ...
    %use_val_parent_target = memref.load %parent_target[%c0] : memref<8xi8, strided<[1], offset: 578>>
