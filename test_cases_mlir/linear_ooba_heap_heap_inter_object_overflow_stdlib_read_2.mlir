...
module {
  ...
  func.func @f() -> i32 {
    ...
    %read_value_166 = memref.alloca() : memref<8xi8>
    memref.copy %origin, %read_value_166 : memref<8xi8> to memref<8xi8>
    %use_val_read_value_166 = memref.load %read_value_166[%c0] : memref<8xi8>
