...
module {
  ...
  func.func @f() -> i32 {
    ...
    %read_value_109 = memref.alloca() : memref<8xi8>
    memref.copy %s_origin, %read_value_109 : memref<8xi8, strided<[1], offset: 0>> to memref<8xi8>
    %use_val_read_value_109 = memref.load %read_value_109[%c0] : memref<8xi8>
    func.call @use(%use_val_read_value_109) : (i8) -> ()
