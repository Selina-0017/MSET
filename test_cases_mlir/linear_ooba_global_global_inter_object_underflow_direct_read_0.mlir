...
module {
  ...
  func.func @f() -> i32 {
    ...
    %parent_origin = memref.subview %parent[0][8][1] : memref<199xi8> to memref<8xi8, strided<[1], offset: 0>>
    %parent_target = memref.subview %parent[191][8][1] : memref<199xi8> to memref<8xi8, strided<[1], offset: 191>>
    %distance_negated = arith.subi %c0, %distance : index
    %use_val_parent_target = memref.load %parent_target[%c0] : memref<8xi8, strided<[1], offset: 191>>
