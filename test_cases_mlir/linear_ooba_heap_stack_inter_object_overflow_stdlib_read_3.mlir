...
module {
  ...
  func.func @f() -> i32 {
    ...
    %parent = memref.alloc() : memref<975xi8>
    %parent_origin = memref.subview %parent[0][8][1] : memref<975xi8> to memref<8xi8>
    %parent_target = memref.subview %parent[967][8][1] : memref<975xi8> to memref<8xi8>
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    ...
    %distance = arith.constant 967 : index
    ...
    memref.dealloc %parent : memref<975xi8>
