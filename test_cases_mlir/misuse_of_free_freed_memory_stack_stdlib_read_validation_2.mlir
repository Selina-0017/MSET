...
module {
  ...
  %c0 = arith.constant 0 : index
    %ret = func.call @f() : () -> i32
  %heap_obj = memref.get_global @heap_obj : memref<8xi8>
  %read_value_27 = memref.alloca() : memref<8xi8>
  memref.copy %heap_obj, %read_value_27 : memref<8xi8> to memref<8xi8>
  %use_val_read_value_27 = memref.load %read_value_27[%c0] : memref<8xi8>
  func.call @use(%use_val_read_value_27) : (i8) -> ()
