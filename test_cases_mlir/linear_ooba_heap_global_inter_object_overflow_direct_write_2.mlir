...
module {
  ...
  func.func @f() -> i32 {
    ...
    %parent = memref.alloc() : memref<485xi8>
    %parent_origin = memref.subview %parent[0][8][1] : memref<485xi8> to memref<8xi8>
    %parent_target = memref.subview %parent[477][8][1] : memref<485xi8> to memref<8xi8>
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    ...
    memref.dealloc %parent : memref<485xi8>
