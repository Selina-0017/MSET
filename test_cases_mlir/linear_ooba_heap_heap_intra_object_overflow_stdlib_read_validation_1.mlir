...
module {
  ...
  func.func @f() -> i32 {
    ...
    %read_value_145 = memref.alloca() : memref<8xi8>
    memref.copy %s_target, %read_value_145 : memref<8xi8, strided<[1], offset: 0>> to memref<8xi8>
    %use_val_read_value_145 = memref.load %read_value_145[%c0] : memref<8xi8>
