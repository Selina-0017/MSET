...
module {
  ...
  func.func @f() -> i32 {
    ...
    memref.copy %src_slice, %read_value_350 : memref<8xi8, strided<[1], offset: ?>> to memref<8xi8>
    %use_val_read_value_350 = memref.load %read_value_350[%c0] : memref<8xi8>
    func.call @use(%use_val_read_value_350) : (i8) -> ()
