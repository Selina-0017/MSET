...
module {
  ...
  func.func @f() -> i32 {
    ...
    %read_value_126 = memref.alloca() : memref<8xi8>
    memref.copy %origin, %read_value_126 : memref<8xi8> to memref<8xi8>
    %use_val_read_value_126 = memref.load %read_value_126[%c0] : memref<8xi8>
