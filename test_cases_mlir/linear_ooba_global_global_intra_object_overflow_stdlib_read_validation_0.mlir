...
module {
  ...
  func.func @f() -> i32 {
    ...
    %use_val_read_value_158 = memref.load %read_value_158[%c0] : memref<1024xi8>
    ...
    %use_val_read_value_159 = memref.load %read_value_159[%c0] : memref<8xi8>
    func.call @use(%use_val_read_value_159) : (i8) -> ()
