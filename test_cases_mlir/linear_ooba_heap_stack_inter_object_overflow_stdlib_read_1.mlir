...
module {
  ...
  func.func @f() -> i32 {
    ...
    %parent = memref.alloc() : memref<79xi8>
    %parent_origin = memref.subview %parent[0][8][1] : memref<79xi8> to memref<8xi8, strided<[1], offset: 0>>
    %parent_target = memref.subview %parent[71][8][1] : memref<79xi8> to memref<8xi8, strided<[1], offset: 71>>
    scf.for %i = %c0 to %c8 step %c1 {
      memref.store %c0xAA, %parent_origin[%i] : memref<8xi8, strided<[1], offset: 0>>
    }
    scf.for %i = %c0 to %c8 step %c1 {
      memref.store %c0xBB, %parent_target[%i] : memref<8xi8, strided<[1], offset: 71>>
    }
    ...
    memref.dealloc %parent : memref<79xi8>
    return %c0_i32 : i32
  }
