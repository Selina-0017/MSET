...
module {
  ...
  func.func @f() -> i32 {
    ...
    %parent = memref.alloca() : memref<288xi8>
    ...
    scf.for %reach_index = %c0 to %distance step %c1 {
      ...
      memref.store %c0xFF, %parent_origin[%index] : memref<8xi8, strided<[1], offset: 280>>
    }
    scf.for %i = %c0 to %c8 step %c1 {
      memref.store %c0xFF, %parent_origin[%i] : memref<8xi8, strided<[1], offset: 280>>
    }
