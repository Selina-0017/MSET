...
module {
  ...
  %read_value_15 = memref.alloca() : memref<8xi8>
  memref.copy %heap_obj, %read_value_15 : memref<8xi8> to memref<8xi8>
  %use_val_read_value_15 = memref.load %read_value_15[%c0] : memref<8xi8>
  func.call @use(%use_val_read_value_15) : (i8) -> ()
