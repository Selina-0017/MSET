...
module {
  ...
  func.func @f() -> i32 {
    ...
    %parent = memref.alloc() : memref<969xi8>
    ...
    %use_val_parent_target = memref.load %parent_target[%c0] : memref<8xi8, strided<[1], offset: 961>>
    ...
    memref.dealloc %parent : memref<969xi8>
    return %c0_i32 : i32
  }
