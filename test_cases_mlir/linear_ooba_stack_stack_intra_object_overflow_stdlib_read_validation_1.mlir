...
module {
  ...
  func.func @f() -> i32 {
    ...
    %read_value_74 = memref.alloca() : memref<1024xi8>
    ...
    ^bb0(%i: index):
      ...
      %dst_slice = memref.subview %read_value_74[%c0][%step][1] : memref<1024xi8> to memref<?xi8, strided<[1], offset: ?>>
    ...
    %use_val_read_value_74 = memref.load %read_value_74[%c0] : memref<1024xi8>
    func.call @use(%use_val_read_value_74) : (i8) -> ()
    %read_value_75 = memref.alloca() : memref<8xi8>
    memref.copy %s_target, %read_value_75 : memref<8xi8, strided<[1], offset: 0>> to memref<8xi8>
